...
| STORY-004: /create-pr skill | 5 | AC-001 (conventional commit title), AC-002 (PR description format) | AC-003 (gh pr create), AC-005 (anti-rationalization) | AC-004 (CSO-compliant description) |

## Cross-cutting Concerns

| Concern | Covered By |
|---------|------------|
| CSO-compliant skill descriptions | STORY-003 (/upgrade-lit skill), STORY-004 AC-004 |
| Anti-rationalization tables | STORY-003 (/upgrade-lit skill), STORY-004 AC-005 |
...
| Conventional commit enforcement | STORY-004 AC-001 (PR titles) |
